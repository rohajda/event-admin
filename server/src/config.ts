...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'EventAdmin';
    ...
    'jhipster.mail.from' = 'EventAdmin@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'EventAdmin API';
    'jhipster.swagger.description' = 'EventAdmin API documentation';
    ...
    'eureka.instance.appname' = 'EventAdmin';
    'eureka.instance.instanceId' = 'EventAdmin:${random.value}';
